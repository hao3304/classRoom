export const CreateShapeInteractor = function(graphView, type, toolbar) {
...
ht.Default.def(CreateShapeInteractor, ht.graph.Interactor, {
  ...
  handle_touchstart: function(e) {
    this._isLeftClick =
      ht.Default.isLeftButton(e) && ht.Default.getTouchCount(e) === 1;
    ...
    if (this._isLeftClick && this._downPoint === this._movePoint) {
      if (ht.Default.isDoubleClick(e)) {
        ...
        if (size > 1) {
          ...
          this._toolbar.handleClick(this._toolbar.getItemById("edit"));
          return;
        }
      } else {
